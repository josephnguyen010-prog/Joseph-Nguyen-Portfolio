...
function Footer() {
  return (
    <footer>
      ...
      <p>Built by Joseph Nguyen with 💜. Based on a <a href="https://github.com/yujisatojr/react-portfolio-template" target="_blank" rel="noreferrer">template by Yuji Sato</a>.</p>
    </footer>
  );
}
